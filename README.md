...
- Redesign the map to expand on the use of the dash
...
- Create a moving platform for the player, you can ether move between two point in code or y ou may want to base if of two actor locations.
